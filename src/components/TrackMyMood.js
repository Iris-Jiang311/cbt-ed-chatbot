...
// import { fetchHuggingFaceResponse } from "../serverApi"; // 你的 Hugging Face API 请求封装
...
//       // 调用 Hugging Face API 生成 CBT-based 反馈
//       const botResponse = await fetchHuggingFaceResponse(userInput);
